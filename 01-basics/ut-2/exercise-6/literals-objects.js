...
export const addSpanishNacionalityAsNewProperty = () => {
  return  person.nationality = "Spanish";
};
...
export const getDescriptionOfGandalf = () => {
  return movie.characters.find((element)=>element.name==="Gandalf").description;
...
export const getRealOfAragorn = () => {
  return movie.characters.find((element)=>element.name==="Aragorn").actor;
